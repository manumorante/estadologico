          ...
          <tr>
			...
			<table border="0" cellspacing="0" cellpadding="2">
				...
				<%if re("R_FECHA") <> "0:00:00" and re("R_FECHA") <> "" then%>
					<tr>
					  <td align="right" valign="middle"><span class="datos-concierto">DíA:</span></td>
				...
				<%if re("R_TEXT3") <> "" then%>
					<tr>
					  <td align="right" valign="middle"><span class="datos-concierto">RECINTO:</span></td>
				...
				<%if re("R_TEXT4") <> "" then%>
					<tr>
					  <td align="right" valign="middle"><span class="datos-concierto">LUGAR:</span></td>
				...
				<%if re("R_TEXT5") <> "" then%>
					<span class="datos-concierto"><a href="<%="http://"& replace(re("R_TEXT5"),"http://","")%>" target="_blank">COMPRA TU ENTRADA</a></span>
				<%end if%>
			...
			<table width="170" height="129" border="0" cellpadding="0" cellspacing="0" background="arch/bg_foto.jpg">
                <tr>
                  <td align="center" valign="middle"><img src="/<%=c_s%>datos/esp/conciertos/fotos/<%=re("R_FOTO")%>" alt="<%=re("R_TITULO")%>" width="156"></td>
                </tr>
            </table>
			<%end if%>
			</td>
