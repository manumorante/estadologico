...
<td colspan="4"><img src="/brmusic/Templates/web_04.jpg" width="635" height="65" alt=""></td><td><img src="espacio.gif" width="1" height="65" alt=""></td></tr><tr><td rowspan="13"><img src="/brmusic/Templates/web_05.jpg" width="37" height="326" alt=""></td><td colspan="2" rowspan="15" align="left" valign="top" background="/brmusic/Templates/web_06.jpg" bgcolor="#EDE6C9"><!-- InstanceBeginEditable name="Cuerpo" -->
        <a href="http://www.brmusic.net/Festival_Atarfe_Vega_Rock/" target="_blank"><img src="arch/atarfe_vega_rock.gif" alt="Atarfe Vega Rock" width="261" height="105" border="0" align="right"></a>
        <p class="titulo-seccion">Festivales</p>
        <h3><STRONG>Atarfe Vega Rock</STRONG></h3>
        <table width="230" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><p><strong>El festival de Rock   más grande de Andalucía </strong></p>
            Los días 10 y 11 de marzo BR music presenta el   festival Atarfe Vega Rock que, como cada año, presenta   &nbsp;las bandas de metal más punteras de la escena internacional. En esta web   encontraras toda la información del festival.</td>
          </tr>
        </table>
